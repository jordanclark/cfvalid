...
<cfif NOT listFindNoCase( arguments.stateList, LOCAL.value ) AND NOT listFindNoCase( arguments.provinceList, LOCAL.value )>
	<cfset LOCAL.value = "">
	<cfset LOCAL.error = "{label} is not a valid state or province.">
</cfif>
